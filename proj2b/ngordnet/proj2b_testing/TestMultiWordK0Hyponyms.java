...
public class TestMultiWordK0Hyponyms {
    ...
    public void testFemaleAnimalK0() {
        ...
        NgordnetQuery nq = new NgordnetQuery(words, 0, 0, 0);
        String actual = studentHandler.handle(nq);
        String expected = "[amazon, bird, cat, chick, dam, demoiselle, female, female_mammal, filly, hag, hen, nanny, nymph, siren]"; //"You have to fill in this text yourself. Hint: COPY FROM THE SPEC!";
        assertEquals(expected, actual);
    }
