...
public class TimeSeries extends TreeMap<Integer, Double> {
    ...
    public TimeSeries(ngordnet.ngrams.TimeSeries ts, int startYear, int endYear) {
        super();
    ...
    public ngordnet.ngrams.TimeSeries plus(ngordnet.ngrams.TimeSeries ts) {
        ngordnet.ngrams.TimeSeries c1 = new ngordnet.ngrams.TimeSeries();
    ...
    public ngordnet.ngrams.TimeSeries dividedBy(ngordnet.ngrams.TimeSeries ts) {
        ngordnet.ngrams.TimeSeries quotient = new ngordnet.ngrams.TimeSeries();
